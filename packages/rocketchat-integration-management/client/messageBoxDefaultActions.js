...
RocketChat.setDefaultActions = function() {
	let messageBoxDefaultActions = new class {
		constructor() {
			this.actions = {};
		}
	...
	messageBoxDefaultActions.add('Create_new', 'Video_message', {
		id: 'video-message',
		icon: 'video',
	...
	messageBoxDefaultActions.add('Create_new', 'Audio_message', {
		id: 'audio-message',
		icon: 'mic',
	...
	messageBoxDefaultActions.add('Add_files_from', 'Computer', {
		id: 'file-upload',
		icon: 'computer',
	...
	messageBoxDefaultActions.add('Share', 'My_location', {
		id: 'share-location',
		icon: 'map-pin',
	...
	return messageBoxDefaultActions;
}
